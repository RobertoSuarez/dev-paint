...
import com.example.dev_paint.adaptadores.TareaAdapter
...
class TareasFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        recyclerView = view.findViewById(R.id.lista_tareas)
        recyclerView.layoutManager = LinearLayoutManager(context)

        User.getCurrentUser { user ->
            Tarea().obtenerTareasPendientesDeEstudiante(user?.id!!) { tareas ->
                tareas.forEach { tarea -> println("${tarea.id}  ${tarea.nombreEstudiante}") }
